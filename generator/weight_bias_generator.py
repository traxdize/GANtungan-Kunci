...
def generate_hex_files2(mat_path, output_dir="model"):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
...
if __name__ == "__main__":
    generate_hex_files('./generator/trained_simple_gan.mat')
    generate_hex_files2('./generator/trained_simple_gan.mat')